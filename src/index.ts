...
import type { TSetup, TRect, TMargin, TRoute, TObservable } from './types/core.js'
...
export { attributes, observable, Doc, cls, fontsReady, platform, Styles, Import, Caller, Api, View, Global, Router, TSetup, TRect, TMargin, TRoute, TObservable }
